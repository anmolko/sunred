                                            ...
                                            <div class="card ctm-border-radius shadow-sm flex-fill">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" maxlength="45" name="subheading" value="{{@$basic_elements->subheading}}">
                                                        <div class="invalid-feedback">
                                             ...
                                             <div class="col-md-12">
                                                 <div class="card ctm-border-radius shadow-sm flex-fill">
                                                     ...
                                                     <div class="card-body">
                                                         <div class="form-group mb-3">
                                                             <label>Heading <span class="text-muted text-danger">*</span></label>
                                                             <input type="text" class="form-control" name="heading" value="{{@$map_descp->heading}}" required>
                                                             <input type="hidden" class="form-control" value="{{$key}}" name="page_section_id" required>
                                                             <input type="hidden" class="form-control" value="{{$value}}" name="section_name" required>
                                                             <div class="invalid-feedback">
                                                                 Please enter the basic section heading.
                                                         ...
                                                         <div class="form-group mb-3">
                                                             <label>Button Text </label>
                                                             <input type="text" maxlength="20" class="form-control" value="{{@$map_descp->button}}" name="button">
                                                             <div class="invalid-feedback">
                                                                 Please enter the button text.
                                                             </div>
                                                         </div>
                                             ...
                                             <div class="col-md-12">
                                                 <div class="card ctm-border-radius shadow-sm flex-fill">
                                                     ...
                                                     <div class="card-body">
                                                         <div class="form-group mb-3">
                                                             <label>Heading </label>
                                                             <input type="text" maxlength="25" class="form-control" value="{{@$header_descp_elements->heading}}" name="heading">
                                                             <div class="invalid-feedback">
                                                     ...
                                                     <div class="card ctm-border-radius shadow-sm flex-fill">
                                                         ...
                                                         <div class="card-body">
                                                             ...
                                                             <div class="form-group mb-3">
                                                                 ...
                                                                 <input type="text" class="form-control" name="subheading[]" value="{{@$accordian2_elements[0]->subheading}}" required>
                                                                 <div class="invalid-feedback">
                                                                     Please enter the sub heading.
                                                                 </div>
                                                             </div>
                                         ...
                                         <div class="row">
                                             <div class="col-md-12">
                                                 <div class="card ctm-border-radius shadow-sm flex-fill">
                                                     ...
                                                     <div class="card-body">
                                                         <h2 class="page-heading">Upload your Images Here <span id="counter2"></span></h2>
                                                         <div class="invalid-feedback">    </div>
                                                         <script type="text/javascript">
                                                             var page_section_id_2 = "{{$key}}";
                                                         </script>
                                                         {!! Form::open(['url'=>route('section-elements-gallery2.update', @$key),'method'=>'PUT','class'=>'dropzone','id'=>'myDropzone2','enctype'=>'multipart/form-data']) !!}
                                                         <div class="dz-message">
                                                             <div class="col-xs-8">
                                                                 <div class="">
                                                                     <p>Drop files here or Click to Upload</p>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="card ctm-border-radius shadow-sm flex-fill">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="form-group mb-3">
                                                                <label>Heading </label>
                                                                <input type="text" class="form-control" name="heading[]" value="{{@$process_elements[0]->heading}}" >
                                                                <div class="invalid-feedback">
                                                                    Please enter the heading.
                                                                </div>
                                                            </div>
                                                            <div class="form-group mb-3">
                                                                <label>Sub Heading </label>
                                                                <input type="text" class="form-control" name="description[]" value="{{@$process_elements[0]->description}}" >
                                                                <div class="invalid-feedback">
                                                                    Please enter the sub heading.
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-8">
                                                                            <div class="form-group mb-3">
                                                                                ...
                                                                                <input type="text" class="form-control" name="list_header[]" value="{{@$process_elements[$i-1]->list_header}}" >
                                                                                <div class="invalid-feedback">
                                                                                    Please enter the heading.
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group mb-3">
                                                                                        <label>Description <span class="text-muted text-danger">*</span></label>
                                                                                        <textarea class="form-control" maxlength="175" rows="8" name="list_description[]" required>{{@$process_elements[$i-1]->list_description}}</textarea>
                                                                                        <div class="invalid-feedback">
                                                                                            Please write the description.
                                                                                        </div>
                                                                                    </div>
...
{{--                                                    </div>--}}
{{--                                                    <span class="ctm-text-sm">*use image minimum of 710 x  695px for Basic section</span>--}}
{{--                                                </div>--}}
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            if(section_list.includes("basic_section")) {
                ...
                createEditor('basic_editor_extra');

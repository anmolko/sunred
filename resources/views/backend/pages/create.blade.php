                            ...
                            <div class="card shadow-none">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label class="image-checkbox">
                                                <img class="img-responsive" src="{{asset('assets/backend/img/page_sections/gallery_section_2.png')}}" width="100%" />
                                                <input type="checkbox" name="section[]" value="gallery_section_2" id="gallery_section_2.png"/>
                                                <i class="ri ri-check-line hidden"></i>
                                            </label>
                                        </div>
                                    </div>

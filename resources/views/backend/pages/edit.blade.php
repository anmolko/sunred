                        ...
                        <div class="card-body doc-boby">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label class='image-checkbox {{(in_array('background_image_section', $sections) ? "image-checkbox-checked":"")}}'>
                                                <img class="img-responsive" src="{{asset('assets/backend/img/page_sections/background_image_section.png')}}" width="90%"/>
                            ...
                            <div class="card shadow-none">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label class="image-checkbox {{(in_array('gallery_section_2', $sections) ? "image-checkbox-checked":"")}}">
                                                <img class="img-responsive" src="{{asset('assets/backend/img/page_sections/gallery_section_2.png')}}" />
                                                <input type="checkbox" name="section[]" value="gallery_section_2" id="gallery_section_2.png" {{(in_array('gallery_section_2', $sections) ? "checked":"")}}  />
                                                <i class="ri ri-check-line hidden"></i>
                                            </label>
                                        </div>
                                    </div>

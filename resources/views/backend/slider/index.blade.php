                    ...
                    <div class="card ctm-border-radius shadow-sm grow flex-fill">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" maxlength="25" class="form-control" name="subheading" required>
                                <div class="invalid-feedback">
                    ...
                    <div class="card ctm-border-radius shadow-sm grow flex-fill">
                        ...
                        <div class="card-body">
                            <div style="margin: auto;width: 60%;">
                                ...
                                <figcaption class="figure-caption">*use image minimum of 1920px x 1080px </figcaption>
                                <div class="invalid-feedback" >

                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" maxlength="200" id="description-input" name="description" placeholder="Enter Testimonial description" rows="4" required></textarea>
                                <div class="invalid-feedback">
    ...
    $(document).on('click','.cs-testimonial-edit', function (e) {
        ...
        $.ajax({
            ...
            success: function(dataResult){
                ...
                $('input:radio[name="edit_rating"]').each(function () {
                    if($(this).val() == dataResult.rating) {

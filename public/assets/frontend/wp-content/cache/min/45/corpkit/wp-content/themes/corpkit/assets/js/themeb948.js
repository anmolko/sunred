(function ($) {
    ...
    var responsive_width =
        corpkit_body_atts && corpkit_body_atts.res_width
            ? corpkit_body_atts.res_width
            : 360;
    $(document).ready(function () {
        ...
        if (css_out != "") {
            $("head").append(
                '<style id="corpkit-shortcode-styles">' + css_out + "</style>"
            );
        }
        ...
        if ($(".sticky-header-space").length) {
            $(".sticky-header-space .corpkit-main-menu")
        ...
        if ($(".mobile-bar").length) {
            if (
                ...
                $(".mobile-bar " + main_menu)
                    ...
                    .slideToggle();
                $(".mobile-bar " + main_menu)
                    .removeClass("corpkit-main-menu")
                    .addClass("corpkit-mobile-menu");
        ...
        var o_stat = 0;
        $(
            ".corpkit-main-menu li.menu-item, .corpkit-mobile-menu li.menu-item"
        ).each(function (index) {
            var cur_item = this;
        ...
        if (o_stat) {
            if (
                $(".corpkit-main-menu .menu-item").find(
                    'a[href="#section-top"]'
                ).length
            ) {
            ...
            $(window).on("scroll", function () {
                var minus_height = $("#wpadminbar").length
                    ...
                    : 0;
                minus_height +=
                    win_width >= corpkit_body_atts.res_width
                        ? parseInt(corpkit_body_atts.menu_offset) + 1
                        : parseInt(corpkit_body_atts.mobile_menu_offset);
                $('section.elementor-section[id*="section-"], body').each(
                    function () {
                        var anchored = $(this).attr("id"),
                            targetOffset = $(this).offset().top - minus_height;
                        if ($(window).scrollTop() > targetOffset) {
                            $(".corpkit-main-menu .menu-item")
                                .find("a")
                                .removeClass("active");
                            $(".corpkit-main-menu .menu-item")
                                .find('a[href="#' + anchored + '"]')
                                .addClass("active");
                            $(".corpkit-mobile-menu .menu-item")
                                .find("a")
                                .removeClass("active");
                            $(".corpkit-mobile-menu .menu-item")
                                .find('a[href="#' + anchored + '"]')
            ...
            $(
                '.corpkit-main-menu .menu-item > a[href^="#section-"], .corpkit-mobile-main-menu .menu-item > a[href^="#section-"]'
            ).on("click", function (e) {
                var cur_item = this;
                ...
                if ($(target_id).length && !another_page) {
                    ...
                    minus_height +=
                        win_width >= corpkit_body_atts.res_width
                            ? parseInt(corpkit_body_atts.menu_offset)
                            : parseInt(corpkit_body_atts.mobile_menu_offset);
        ...
        if ($(".textbox-search-toggle").length) {
            ...
            $(document).on("click", ".full-bar-search-toggle", function () {
                ...
                setTimeout(function () {
                    var search_in = $(".full-bar-search-wrap").find(
                        "input.form-control"
                    );
                    search_in.focus();
                }, 350);
        ...
        if ($(".zozo-mc").length) {
            $(".zozo-mc").on("click", function () {
                ...
                if (mc_form.find('input[name="zozo_mc_email"]').val() == "") {
                    mc_wrap
                        .find(".mc-notice-msg")
                        .text(corpkit_ajax_var.must_fill);
                } else {
        ...
        if ($(".popover-wrapper .popover-trigger").length) {
            $(".popover-trigger").each(function (index) {
                var _evnt_name = $(this).attr("data-event")
    ...
    function corpkit_owl_settings(c_owlCarousel) {
        var page_slide = !1;
        var pagi_slide = !1;
        if (c_owlCarousel.hasClass("corpkit-page-carousel")) {
            page_slide = !0;
        }
        if (c_owlCarousel.hasClass("corpkit-pagination-carousel")) {
            pagi_slide = !0;
        }
        ...
        if (pagi_slide) {
            var cur_testi_slide = $(c_owlCarousel)
                .parent("div")
                .children(".corpkit-page-carousel");
        ...
        if (page_slide) {
            var cur_pagination_slide = $(c_owlCarousel)
                .parent("div")
                .children(".corpkit-pagination-carousel");

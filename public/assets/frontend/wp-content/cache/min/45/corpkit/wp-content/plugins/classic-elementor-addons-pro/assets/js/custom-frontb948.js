(function ($) {
    ...
    var WidgetModalPopupHandler = function ($scope, $) {
        if ($scope.find(".modal-popup-wrapper.page-load-modal").length) {
            var modal_id = $scope
                .find(".modal-popup-wrapper.page-load-modal .modal")
                .attr("id");
            $("#" + modal_id).modal("show");
        }
    };
    ...
    var WidgetModalPopupHandler = function ($scope, $) {
        ...
        if ($scope.find(".cea-page-load-modal").length) {
            var modal_id = $scope
                .find(".cea-page-load-modal .white-popup-block")
                .attr("id");
            $.magnificPopup.open({
                items: { src: "#" + modal_id },
                type: "inline",
    ...
    var WidgetRecentPopularToggleHandler = function ($scope, $) {
        if ($scope.find(".cea-toggle-post-trigger").length) {
            $scope
                .find(".cea-toggle-post-trigger .switch-checkbox")
                .change(function () {
    ...
    var ColumnCustomOptionsHandler = function ($scope, $) {
        if ($scope.is(".elementor-element.elementor-column")) {
            if (
                $scope.is(".elementor-element.elementor-column[data-cea-slide]")
            ) {
    ...
    var WidgetCeaAccordionHandler = function ($scope, $) {
        if ($scope.find(".cea-accordion-elementor-widget").length) {
            $scope
                .find(".cea-accordion-elementor-widget")
                .each(function (index) {
    ...
    $(window).on("elementor/frontend/init", function () {
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/ceaanimatedtext.default",
            WidgetAnimateTextHandler
        );
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/ceacircleprogress.default",
            WidgetCircleProgressHandler
        );
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/ceacounter.default",
            WidgetCounterUpHandler
        );
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/ceadaycounter.default",
            WidgetDayCounterHandler
        );
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/ceaimagegrid.default",
        ...
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/ceamodalpopup.default",
            WidgetModalPopupHandler
        );
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/ceatimeline.default",
            WidgetAgonHandler
        );
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/ceagooglemap.default",
            WidgetCEAMapHandler
        );
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/ceatimelineslide.default",
            WidgetTimelineSliderHandler
        );
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/ceachart.default",
            WidgetChartHandler
        );
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/carousel3d.default",
            WidgetCloud9CarouselHandler
        );
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/raindrops.default",
            WidgetRainDropsHandler
        );
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/ceapopover.default",
            WidgetPopoverHandler
        );
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/ceapopupanything.default",
            WidgetPopupAnythingHandler
        );
        elementorFrontend.hooks.addAction(
        ...
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/ceatab.default",
            WidgetCeaTabHandler
        );
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/ceaaccordion.default",
            WidgetCeaAccordionHandler
        );
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/ceaswitchercontent.default",
            WidgetSwitcherContentHandler
        );
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/ceaoffcanvas.default",
            WidgetCeaOffcanvasHandler
        );
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/ceablog.default",
        ...
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/cearecentpopular.default",
            WidgetRecentPopularToggleHandler
        );
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/ceateam.default",
            WidgetOwlCarouselHandler
        );
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/ceaevent.default",
            WidgetOwlCarouselHandler
        );
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/ceatestimonial.default",
            WidgetOwlCarouselHandler
        );
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/ceaportfolio.default",
            WidgetIsotopeHandler
        );
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/ceaportfolio.default",
        ...
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/ceaservice.default",
            WidgetOwlCarouselHandler
        );
        elementorFrontend.hooks.addAction(
        ...
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/contentcarousel.default",
            WidgetAllInOneHandler
        );
    });
    ...
    function cea_scroll_animation(c_elem) {
        setTimeout(function () {
            var anim_time = 300;
            $(c_elem)
                .find(".cea-animate:not(.run-animate)")
                .each(function () {
                    var elem = $(this);
    ...
    function ceaOffcanvasContent(offcanvas_ele) {
        ...
        if (
            $(document).find(".cea-offcanvas-id-to-element").length &&
            !$("body.elementor-editor-active").length
        ) {
            $(document)
                .find(".cea-offcanvas-id-to-element")
                .each(function (index) {
                    var offcanvas_id_ele = $(this).data("id");
                    var clone_offcanvas = $("#" + offcanvas_id_ele).clone();
                    $(document)
                        .find("#" + offcanvas_id_ele)
                        .remove();
                    $(this).replaceWith(clone_offcanvas);
                });
        }
        $(offcanvas_ele)
            .find(".cea-offcanvas-trigger")
            .on("click", function () {
                ...
                if ($("#" + offcanvas_id).length) {
                    ...
                    var ani_type = $("#" + offcanvas_id).data(
                        "canvas-animation"
                    );
                    if (ani_type == "left-push") {
                        $("body").css({
                            "margin-left":
                                $("#" + offcanvas_id).outerWidth() + "px",
                            "margin-right":
                                "-" + $("#" + offcanvas_id).outerWidth() + "px",
                        });
                    } else if (ani_type == "right-push") {
    ...
    function ceaSwitcherContent(switcher_ele) {
        ...
        if (
            switcher_ele.find(".cea-switcher-id-to-element").length &&
            !$("body.elementor-editor-active").length
        ) {
            switcher_ele
                .find(".cea-switcher-id-to-element")
                .each(function (index) {
                    var switcher_id_ele = $(this).data("id");
                    var clone_tab = $("#" + switcher_id_ele).clone();
                    $(document)
                        .find("#" + switcher_id_ele)
                        .remove();
        ...
        $(switcher_ele)
            ...
            .on("change", function () {
                ...
                if (this.checked) {
                    ...
                    $(this)
                        .parents("ul")
                        .find(".cea-secondary-switch")
                        .addClass("switcher-active");
                    $(switcher_ele)
                        .find(
                            ".cea-switcher-content > div.cea-switcher-secondary"
                        )
                        .fadeIn(350);
                } else {
                    $(this)
                    ...
                    $(this)
                        .parents("ul")
                        .find(".cea-primary-switch")
                        .addClass("switcher-active");
                    $(switcher_ele)
                        .find(
                            ".cea-switcher-content > div.cea-switcher-primary"
                        )
                        .fadeIn(350);
                }
            });
    ...
    function ceaAccordionContent(accordion_ele) {
        ...
        if (
            accordion_ele.find(".cea-accordion-id-to-element").length &&
            !$("body.elementor-editor-active").length
        ) {
            accordion_ele
                .find(".cea-accordion-id-to-element")
                .each(function (index) {
                    var accordion_id_ele = $(this).data("id");
                    var clone_tab = $("#" + accordion_id_ele).clone();
                    $(document)
                        .find("#" + accordion_id_ele)
                        .remove();
                    $(this).replaceWith(clone_tab);
                });
        }
        $(accordion_ele)
            .find(".cea-accordion-header a")
            .on("click", function () {
                var cur_tab = $(this);
                var accordion_id = $(cur_tab).attr("href");
                var accordion_wrap = $(cur_tab).parents(
                    ".cea-accordion-elementor-widget"
                );
    ...
    function ceaTabContent(tabs_ele) {
        ...
        if (
            tabs_ele.find(".cea-tab-id-to-element").length &&
            !$("body.elementor-editor-active").length
        ) {
        ...
        $(tabs_ele)
            ...
            .on("click", function () {
                ...
                $(cur_tab).addClass("active");
                var tab_content_wrap = $(cur_tab)
                    .parents(".cea-tabs")
                    .next(".cea-tab-content");
    ...
    function ceaToggleContent(toggle_ele) {
        ...
        $(toggle_ele)
            ...
            .bind("click", function (e) {
                ...
                $(toggle_ele)
                    .parent(".toggle-content-inner")
                    .find(".toggle-content-trigger .button-inner-down")
                    .fadeToggle(0);
                $(toggle_ele)
                    .parent(".toggle-content-inner")
                    .find(".toggle-content-trigger .button-inner-up")
                    .fadeToggle(0);
    ...
    function ceaContentSlider(slide_ele) {
        ...
        var slide_json = JSON.parse(
            decodeURIComponent(slide_ele.attr("data-cea-slide"))
        );
    ...
    function ceaSectionRainDrops(rd_ele) {
        ...
        var rd_json = JSON.parse(
            decodeURIComponent(rd_ele.attr("data-cea-raindrops"))
        );
    ...
    function ceaSectionParallax(pr_ele) {
        ...
        var pr_json = JSON.parse(
            decodeURIComponent(pr_ele.attr("data-cea-parallax-data"))
        );
        var parallax_ratio = pr_json.parallax_ratio;
        var parallax_img = pr_json.parallax_image;
        pr_ele.prepend(
            '<div class="cea-parallax" data-cea-parallax data-speed="' +
                parallax_ratio +
    ...
    function ceaSectionFloatParallax(pr_ele) {
        var pr_ele = $(pr_ele);
        var pr_json = JSON.parse(
            decodeURIComponent(pr_ele.attr("data-cea-float"))
        );
    ...
    function ceaPopover(popover_ele) {
        ...
        var evnt_name = popover_ele.attr("data-event")
            ? popover_ele.attr("data-event")
            : "hover";
        if (evnt_name == "hover") {
            popover_ele
    ...
    function ceaSwitchTabToggle(toggle_ele) {
        if (toggle_ele.checked) {
            ...
            toggle_ele
                .parents(".cea-toggle-post-wrap")
                .addClass("cea-active-post");
        } else {
            var toggle_ele = $(toggle_ele);
            toggle_ele
                .parents(".cea-toggle-post-wrap")
                .removeClass("cea-active-post");
        }
    }
